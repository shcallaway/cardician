  ...
  class Session
    ...
    def self.from_config(config, options = {})
      ...
      if config.refresh_token
        ...
        $stderr.print("You need to authenticate this app with Google. Visit this page:\n")
        $stderr.print(("%s\n" % credentials.authorization_uri).colorize(:green))
        $stderr.print('Copy and paste the code: ')
